...
public:
	...
	__forceinline void DrawFilledRectFade(int x0, int y0, int x1, int y1, uint32_t alpha0, uint32_t alpha1, bool bHorizontal) {
		return util::get_method< void(__thiscall*)(decltype(this), int, int, int, int, uint32_t, uint32_t, bool) >(this, DRAWFILLEDRECTcheat)(this, x0, y0, x1, y1, alpha0, alpha1, bHorizontal);
	}
	...
	__forceinline void DrawFilledRectcheat( int x0, int y0, int x1, int y1, uint32_t alpha0, uint32_t alpha1, bool bHorizontal ) {
		return util::get_method< void( __thiscall* )( decltype( this ), int, int, int, int, uint32_t, uint32_t, bool ) >( this, DRAWFILLEDRECTcheat )( this, x0, y0, x1, y1, alpha0, alpha1, bHorizontal );
	}
