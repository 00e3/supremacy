...
public:
	...
	__forceinline void SetVecValue(float r, float g, float b) {
		using original_fn = void(__thiscall*)(c_material_var*, float, float, float);
		return (*(original_fn**)this)[11](this, r, g, b);
	}


	__forceinline void SetFloatValue(float val) {
		using original_fn = void(__thiscall*)(c_material_var*, float);
